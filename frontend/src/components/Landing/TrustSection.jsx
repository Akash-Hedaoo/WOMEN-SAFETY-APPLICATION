            ...
            <div className="mx-auto grid max-w-7xl gap-8 px-6 md:px-8 lg:grid-cols-5">
                <div className="lg:col-span-3">
                    <div className="premium-panel-strong p-8 md:p-10">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#7A8E72]">Trust signal</p>
                        <blockquote className="mt-5 space-y-5">
                            <p className="font-headline text-2xl font-semibold leading-tight text-[#28302A] md:text-4xl">
                                “A safety product can be powerful without feeling aggressive.”
                            </p>
                            <p className="max-w-2xl text-sm leading-relaxed text-[#687067] md:text-base">
                            ...
                            <footer className="text-xs font-semibold uppercase tracking-[0.22em] text-[#7A8E72]">
                ...
                <div className="lg:col-span-2 space-y-4">
                    {partners.map((partner) => (
                        <div key={partner.name} className="premium-panel flex items-center gap-4 p-4">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-[#28302A]">{partner.name}</p>
                                <p className="text-xs text-[#687067]">{partner.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
